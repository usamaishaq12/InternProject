        ...
        <View style={styles.mainViewContainer}>
          <View style={styles.container}>
            <Text style={styles.text1}>
              Terms & Conditions {"\n"}
              <Text style={styles.text2}>Welcome to APP_NAME!</Text>
            </Text>
            <Text style={styles.text2}>
              These terms and conditions outline the rules and regulations for
              the use of COMPANY_NAME’s Website, located at
              WWW.COMPANY_WEBSITE.COM.{" "}
            </Text>
            <Text style={styles.text2}>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use COMPANY_WEBSITE if you do not
            ...
            <Text style={styles.text2}>
              ...
              accessing COMPANY_WEBSITE, you agreed to use cookies in agreement
              with the COMPANY_NAME’s Privacy Policy. Most interactive websites
              ...
              License Unless otherwise stated, COMPANY_NAME and/or its licensors
              own the intellectual property rights for all material on
              COMPANY_WEBSITE. All intellectual property rights are reserved.
              You may access this from COMPANY_WEBSITE for your own personal use
              subjected to restrictions set in these terms and conditions. You
              must not: Republish material from COMPANY_WEBSITE Sell, rent or
              sub-license material from COMPANY_WEBSITE Reproduce, duplicate or
              copy material from COMPANY_WEBSITE Redistribute content from
              COMPANY_WEBSITE This Agreement shall begin on the date hereof. Our
              ...
              areas of the website. COMPANY_NAME does not filter, edit, publish
              or review Comments prior to their presence on the website.
              Comments do not reflect the views and opinions of COMPANY_NAME,its
              ...
              permitted by applicable laws, COMPANY_NAME shall not be liable for
              ...
              appearance of the Comments on this website. COMPANY_NAME reserves
              ...
              activity. You hereby grant COMPANY_NAME a non-exclusive license to
              ...
              COMPANY_NAME; and (d) the link is in the context of general
              ...
              COMPANY_NAME. Please include your name, your organization name,
              ...
              the context and format of content on the linking party’s site. No
              use of COMPANY_NAME's logo or other artwork will be allowed for
              linking absent a trademark license agreement. iFrames Without
              prior approval and written permission, you may not create frames
              around our Webpages that alter in any way the visual presentation
              or appearance of our Website. Content Liability We shall not be
              hold responsible for any content that appears on your Website. You
              agree to protect and defend us against all claims that is rising
              on your Website. No link(s) should appear on any Website that may
              be interpreted as libelous, obscene or criminal, or which
              infringes, otherwise violates, or advocates the infringement or
              other violation of, any third party rights. Your Privacy Please
              read Privacy Policy Reservation of Rights We reserve the right to
              request that you remove all links or any particular link to our
              Website. You approve to immediately remove all links to our
              ...
              follow these linking terms and conditions. Removal of links from
              our website If you find any link on our Website that is offensive
              for any reason, you are free to contact and inform us any moment.
              ...
              that may not be excluded under applicable law. The limitations and
              prohibitions of liability set in this Section and elsewhere in
              this disclaimer: (a) are subject to the preceding paragraph; and
